...
public class InternalXtextGrammarTestLanguageLexer extends Lexer {
    ...
    public final void mT__21() throws RecognitionException {
        try {
            int _type = T__21;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:21:7: ( 'returns' )
            // InternalXtextGrammarTestLanguage.g:21:9: 'returns'
            {
            match("returns"); 
    ...
    public final void mT__32() throws RecognitionException {
        try {
            int _type = T__32;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:32:7: ( 'current' )
            // InternalXtextGrammarTestLanguage.g:32:9: 'current'
            {
            match("current"); 
    ...
    public final void mT__37() throws RecognitionException {
        try {
            int _type = T__37;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:37:7: ( 'terminal' )
            // InternalXtextGrammarTestLanguage.g:37:9: 'terminal'
            {
            match("terminal"); 
    ...
    public final void mT__41() throws RecognitionException {
        try {
            int _type = T__41;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:41:7: ( 'enum' )
            // InternalXtextGrammarTestLanguage.g:41:9: 'enum'
            {
            match("enum"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2229:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalXtextGrammarTestLanguage.g:2229:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalXtextGrammarTestLanguage.g:2229:11: ( '^' )?
            int alt1=2;
            ...
            // InternalXtextGrammarTestLanguage.g:2229:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2231:10: ( ( '0' .. '9' )+ )
            // InternalXtextGrammarTestLanguage.g:2231:12: ( '0' .. '9' )+
            {
            // InternalXtextGrammarTestLanguage.g:2231:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalXtextGrammarTestLanguage.g:2231:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2233:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalXtextGrammarTestLanguage.g:2233:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalXtextGrammarTestLanguage.g:2233:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalXtextGrammarTestLanguage.g:2233:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalXtextGrammarTestLanguage.g:2233:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalXtextGrammarTestLanguage.g:2233:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalXtextGrammarTestLanguage.g:2233:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalXtextGrammarTestLanguage.g:2233:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalXtextGrammarTestLanguage.g:2233:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalXtextGrammarTestLanguage.g:2233:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalXtextGrammarTestLanguage.g:2233:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2235:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalXtextGrammarTestLanguage.g:2235:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalXtextGrammarTestLanguage.g:2235:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalXtextGrammarTestLanguage.g:2235:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2237:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalXtextGrammarTestLanguage.g:2237:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalXtextGrammarTestLanguage.g:2237:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalXtextGrammarTestLanguage.g:2237:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalXtextGrammarTestLanguage.g:2237:41: ( '\\r' )? '\\n'
                    {
                    // InternalXtextGrammarTestLanguage.g:2237:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2239:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalXtextGrammarTestLanguage.g:2239:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalXtextGrammarTestLanguage.g:2239:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXtextGrammarTestLanguage.g:2241:16: ( . )
            // InternalXtextGrammarTestLanguage.g:2241:18: .
            {
            matchAny(); 
