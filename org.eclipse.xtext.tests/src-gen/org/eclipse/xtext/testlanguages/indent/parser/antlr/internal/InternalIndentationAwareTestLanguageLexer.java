...
public class InternalIndentationAwareTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            ...
            // InternalIndentationAwareTestLanguage.g:208:9: ( ( '\\r' | '\\n' )+ ( '\\t' )* )
            // InternalIndentationAwareTestLanguage.g:208:11: ( '\\r' | '\\n' )+ ( '\\t' )*
            {
            // InternalIndentationAwareTestLanguage.g:208:11: ( '\\r' | '\\n' )+
            int cnt1=0;
            loop1:
            ...
            // InternalIndentationAwareTestLanguage.g:208:24: ( '\\t' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_BEGIN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalIndentationAwareTestLanguage.g:210:12: ( '{' )
            // InternalIndentationAwareTestLanguage.g:210:14: '{'
            {
            match('{'); 
    ...
    public final void mRULE_END() throws RecognitionException {
        try {
            int _type = RULE_END;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalIndentationAwareTestLanguage.g:212:10: ( '}' )
            // InternalIndentationAwareTestLanguage.g:212:12: '}'
            {
            match('}'); 
    ...
    public final void mRULE_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalIndentationAwareTestLanguage.g:214:12: ( . )
            // InternalIndentationAwareTestLanguage.g:214:14: .
            {
            matchAny(); 
