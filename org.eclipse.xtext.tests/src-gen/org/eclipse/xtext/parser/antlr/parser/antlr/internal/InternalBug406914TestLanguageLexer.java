...
public class InternalBug406914TestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug406914TestLanguage.g:157:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalBug406914TestLanguage.g:157:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalBug406914TestLanguage.g:157:11: ( '^' )?
            int alt1=2;
            ...
            // InternalBug406914TestLanguage.g:157:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug406914TestLanguage.g:159:9: ( ( ' ' | '\\t' )+ )
            // InternalBug406914TestLanguage.g:159:11: ( ' ' | '\\t' )+
            {
            // InternalBug406914TestLanguage.g:159:11: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug406914TestLanguage.g:161:16: ( . )
            // InternalBug406914TestLanguage.g:161:18: .
            {
            matchAny(); 
