...
public class InternalEcoreTerminalsTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_EDOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:151:14: ( ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ) ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )? )
            // InternalEcoreTerminalsTestLanguage.g:151:16: ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ) ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )?
            {
            // InternalEcoreTerminalsTestLanguage.g:151:16: ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalEcoreTerminalsTestLanguage.g:151:17: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalEcoreTerminalsTestLanguage.g:151:21: ( '0' .. '9' )+
                    int cnt1=0;
                    loop1:
                    do {
                        int alt1=2;
                        ...
                        switch (alt1) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:151:22: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // InternalEcoreTerminalsTestLanguage.g:151:33: ( '0' .. '9' )+ '.' ( '0' .. '9' )*
                    {
                    // InternalEcoreTerminalsTestLanguage.g:151:33: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:151:34: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    match('.'); 
                    // InternalEcoreTerminalsTestLanguage.g:151:49: ( '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:151:50: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
            ...
            // InternalEcoreTerminalsTestLanguage.g:151:62: ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalEcoreTerminalsTestLanguage.g:151:63: ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+
                    {
                    ...
                    // InternalEcoreTerminalsTestLanguage.g:151:73: ( '-' | ( '+' )? )
                    int alt6=2;
                    ...
                    switch (alt6) {
                        case 1 :
                            // InternalEcoreTerminalsTestLanguage.g:151:74: '-'
                            {
                            match('-'); 
                            ...
                            break;
                        case 2 :
                            // InternalEcoreTerminalsTestLanguage.g:151:78: ( '+' )?
                            {
                            // InternalEcoreTerminalsTestLanguage.g:151:78: ( '+' )?
                            int alt5=2;
                    ...
                    // InternalEcoreTerminalsTestLanguage.g:151:84: ( '0' .. '9' )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:151:85: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_EDATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:153:12: ( '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' 'T' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' ( '+' | '-' ) '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalEcoreTerminalsTestLanguage.g:153:14: '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' 'T' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' ( '+' | '-' ) '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_EINT() throws RecognitionException {
        try {
            int _type = RULE_EINT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:155:11: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalEcoreTerminalsTestLanguage.g:155:13: ( '-' )? ( '0' .. '9' )+
            {
            // InternalEcoreTerminalsTestLanguage.g:155:13: ( '-' )?
            int alt9=2;
            ...
            // InternalEcoreTerminalsTestLanguage.g:155:18: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalEcoreTerminalsTestLanguage.g:155:19: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:157:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEcoreTerminalsTestLanguage.g:157:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEcoreTerminalsTestLanguage.g:157:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
