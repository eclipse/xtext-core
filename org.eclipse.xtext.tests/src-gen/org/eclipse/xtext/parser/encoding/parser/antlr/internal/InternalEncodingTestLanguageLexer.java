...
public class InternalEncodingTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_LEXEME() throws RecognitionException {
        try {
            ...
            // InternalEncodingTestLanguage.g:124:13: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )* )
            // InternalEncodingTestLanguage.g:124:15: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )*
            {
            // InternalEncodingTestLanguage.g:124:15: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )*
            loop1:
            do {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEncodingTestLanguage.g:126:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEncodingTestLanguage.g:126:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEncodingTestLanguage.g:126:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEncodingTestLanguage.g:128:16: ( . )
            // InternalEncodingTestLanguage.g:128:18: .
            {
            matchAny(); 
