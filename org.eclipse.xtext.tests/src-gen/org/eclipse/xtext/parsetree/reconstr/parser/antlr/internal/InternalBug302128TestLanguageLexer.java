...
public class InternalBug302128TestLanguageLexer extends Lexer {
    ...
    public final void mRULE_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:188:12: ( ( '=' | '+=' | '-=' ) ( options {greedy=false; } : . )* '\\n' )
            // InternalBug302128TestLanguage.g:188:14: ( '=' | '+=' | '-=' ) ( options {greedy=false; } : . )* '\\n'
            {
            // InternalBug302128TestLanguage.g:188:14: ( '=' | '+=' | '-=' )
            int alt1=3;
            switch ( input.LA(1) ) {
            case '=':
                {
            ...
            switch (alt1) {
                case 1 :
                    // InternalBug302128TestLanguage.g:188:15: '='
                    {
                    match('='); 
                    ...
                    break;
                case 2 :
                    // InternalBug302128TestLanguage.g:188:19: '+='
                    {
                    match("+="); 
                    ...
                    break;
                case 3 :
                    // InternalBug302128TestLanguage.g:188:24: '-='
                    {
                    match("-="); 
            ...
            // InternalBug302128TestLanguage.g:188:30: ( options {greedy=false; } : . )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalBug302128TestLanguage.g:188:58: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:190:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBug302128TestLanguage.g:190:19: '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('#'); 
            // InternalBug302128TestLanguage.g:190:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalBug302128TestLanguage.g:190:39: ( ( '\\r' )? '\\n' )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalBug302128TestLanguage.g:190:40: ( '\\r' )? '\\n'
                    {
                    // InternalBug302128TestLanguage.g:190:40: ( '\\r' )?
                    int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:192:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalBug302128TestLanguage.g:192:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalBug302128TestLanguage.g:192:11: ( '^' )?
            int alt6=2;
            ...
            // InternalBug302128TestLanguage.g:192:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:194:10: ( ( '0' .. '9' )+ )
            // InternalBug302128TestLanguage.g:194:12: ( '0' .. '9' )+
            {
            // InternalBug302128TestLanguage.g:194:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalBug302128TestLanguage.g:194:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:196:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalBug302128TestLanguage.g:196:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalBug302128TestLanguage.g:196:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalBug302128TestLanguage.g:196:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalBug302128TestLanguage.g:196:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalBug302128TestLanguage.g:196:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalBug302128TestLanguage.g:196:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalBug302128TestLanguage.g:196:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalBug302128TestLanguage.g:196:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalBug302128TestLanguage.g:196:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalBug302128TestLanguage.g:196:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:198:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalBug302128TestLanguage.g:198:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalBug302128TestLanguage.g:198:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalBug302128TestLanguage.g:198:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:200:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalBug302128TestLanguage.g:200:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalBug302128TestLanguage.g:200:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug302128TestLanguage.g:202:16: ( . )
            // InternalBug302128TestLanguage.g:202:18: .
            {
            matchAny(); 
