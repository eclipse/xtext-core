...
public class InternalUnassignedTextTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_CASEINSENSITIVEKEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:468:29: ( ( 'k' | 'K' ) ( 'e' | 'E' ) ( 'y' | 'Y' ) ( 'w' | 'W' ) ( 'o' | 'O' ) ( 'r' | 'R' ) ( 'd' | 'D' ) )
            // InternalUnassignedTextTestLanguage.g:468:31: ( 'k' | 'K' ) ( 'e' | 'E' ) ( 'y' | 'Y' ) ( 'w' | 'W' ) ( 'o' | 'O' ) ( 'r' | 'R' ) ( 'd' | 'D' )
            {
    ...
    public final void mRULE_PLURAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:470:13: ( ( 'item' | 'items' ) )
            // InternalUnassignedTextTestLanguage.g:470:15: ( 'item' | 'items' )
            {
            // InternalUnassignedTextTestLanguage.g:470:15: ( 'item' | 'items' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalUnassignedTextTestLanguage.g:470:16: 'item'
                    {
                    match("item"); 
                    ...
                    break;
                case 2 :
                    // InternalUnassignedTextTestLanguage.g:470:23: 'items'
                    {
                    match("items"); 
    ...
    public final void mRULE_MULTI() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:472:12: ( 'a' ( 'b' )? ( 'c' )+ ( 'd' )* ( 'e' | 'f' ) ( ( 'g' | 'h' ) | ( 'i' )+ ) RULE_MULTI2 '0' .. '9' ( '0' .. '9' )+ )
            // InternalUnassignedTextTestLanguage.g:472:14: 'a' ( 'b' )? ( 'c' )+ ( 'd' )* ( 'e' | 'f' ) ( ( 'g' | 'h' ) | ( 'i' )+ ) RULE_MULTI2 '0' .. '9' ( '0' .. '9' )+
            {
            match('a'); 
            // InternalUnassignedTextTestLanguage.g:472:18: ( 'b' )?
            int alt2=2;
            ...
            // InternalUnassignedTextTestLanguage.g:472:23: ( 'c' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
            ...
            // InternalUnassignedTextTestLanguage.g:472:28: ( 'd' )*
            loop4:
            do {
                int alt4=2;
            ...
            // InternalUnassignedTextTestLanguage.g:472:43: ( ( 'g' | 'h' ) | ( 'i' )+ )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalUnassignedTextTestLanguage.g:472:44: ( 'g' | 'h' )
                    {
                    ...
                    break;
                case 2 :
                    // InternalUnassignedTextTestLanguage.g:472:54: ( 'i' )+
                    {
                    // InternalUnassignedTextTestLanguage.g:472:54: ( 'i' )+
                    int cnt5=0;
                    loop5:
            ...
            mRULE_MULTI2(); 
            matchRange('0','9'); 
            // InternalUnassignedTextTestLanguage.g:472:81: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalUnassignedTextTestLanguage.g:472:82: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_MULTI2() throws RecognitionException {
        try {
            // InternalUnassignedTextTestLanguage.g:474:22: ( 'j' )
            // InternalUnassignedTextTestLanguage.g:474:24: 'j'
            {
            match('j'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:476:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalUnassignedTextTestLanguage.g:476:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalUnassignedTextTestLanguage.g:476:11: ( '^' )?
            int alt8=2;
            ...
            // InternalUnassignedTextTestLanguage.g:476:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:478:10: ( ( '0' .. '9' )+ )
            // InternalUnassignedTextTestLanguage.g:478:12: ( '0' .. '9' )+
            {
            // InternalUnassignedTextTestLanguage.g:478:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalUnassignedTextTestLanguage.g:478:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:480:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalUnassignedTextTestLanguage.g:480:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalUnassignedTextTestLanguage.g:480:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalUnassignedTextTestLanguage.g:480:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalUnassignedTextTestLanguage.g:480:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                        ...
                        switch (alt11) {
                    	case 1 :
                    	    // InternalUnassignedTextTestLanguage.g:480:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalUnassignedTextTestLanguage.g:480:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalUnassignedTextTestLanguage.g:480:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalUnassignedTextTestLanguage.g:480:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
                        ...
                        switch (alt12) {
                    	case 1 :
                    	    // InternalUnassignedTextTestLanguage.g:480:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalUnassignedTextTestLanguage.g:480:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:482:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalUnassignedTextTestLanguage.g:482:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalUnassignedTextTestLanguage.g:482:24: ( options {greedy=false; } : . )*
            loop14:
            do {
                int alt14=2;
                ...
                switch (alt14) {
            	case 1 :
            	    // InternalUnassignedTextTestLanguage.g:482:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:484:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalUnassignedTextTestLanguage.g:484:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalUnassignedTextTestLanguage.g:484:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop15:
            do {
                int alt15=2;
            ...
            // InternalUnassignedTextTestLanguage.g:484:40: ( ( '\\r' )? '\\n' )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalUnassignedTextTestLanguage.g:484:41: ( '\\r' )? '\\n'
                    {
                    // InternalUnassignedTextTestLanguage.g:484:41: ( '\\r' )?
                    int alt16=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:486:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalUnassignedTextTestLanguage.g:486:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalUnassignedTextTestLanguage.g:486:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUnassignedTextTestLanguage.g:488:16: ( . )
            // InternalUnassignedTextTestLanguage.g:488:18: .
            {
            matchAny(); 
