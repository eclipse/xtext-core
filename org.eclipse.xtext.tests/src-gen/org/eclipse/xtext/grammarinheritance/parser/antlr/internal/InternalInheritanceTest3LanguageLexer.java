...
public class InternalInheritanceTest3LanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:300:9: ( 'id' )
            // InternalInheritanceTest3Language.g:300:11: 'id'
            {
            match("id"); 
    ...
    public final void mSUPER_ID() throws RecognitionException {
        try {
            int _type = SUPER_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:302:10: ( ( 'a' .. 'z' )+ )
            // InternalInheritanceTest3Language.g:302:12: ( 'a' .. 'z' )+
            {
            // InternalInheritanceTest3Language.g:302:12: ( 'a' .. 'z' )+
            int cnt1=0;
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalInheritanceTest3Language.g:302:13: 'a' .. 'z'
            	    {
            	    matchRange('a','z'); 
    ...
    public final void mSUPER_1_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:304:12: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalInheritanceTest3Language.g:304:14: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalInheritanceTest3Language.g:304:14: ( '^' )?
            int alt2=2;
            ...
            // InternalInheritanceTest3Language.g:304:43: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:306:10: ( ( '0' .. '9' )+ )
            // InternalInheritanceTest3Language.g:306:12: ( '0' .. '9' )+
            {
            // InternalInheritanceTest3Language.g:306:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalInheritanceTest3Language.g:306:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:308:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalInheritanceTest3Language.g:308:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalInheritanceTest3Language.g:308:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalInheritanceTest3Language.g:308:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalInheritanceTest3Language.g:308:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalInheritanceTest3Language.g:308:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInheritanceTest3Language.g:308:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalInheritanceTest3Language.g:308:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalInheritanceTest3Language.g:308:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalInheritanceTest3Language.g:308:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInheritanceTest3Language.g:308:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:310:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalInheritanceTest3Language.g:310:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalInheritanceTest3Language.g:310:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalInheritanceTest3Language.g:310:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:312:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalInheritanceTest3Language.g:312:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalInheritanceTest3Language.g:312:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
            ...
            // InternalInheritanceTest3Language.g:312:40: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalInheritanceTest3Language.g:312:41: ( '\\r' )? '\\n'
                    {
                    // InternalInheritanceTest3Language.g:312:41: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:314:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalInheritanceTest3Language.g:314:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalInheritanceTest3Language.g:314:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest3Language.g:316:16: ( . )
            // InternalInheritanceTest3Language.g:316:18: .
            {
            matchAny(); 
