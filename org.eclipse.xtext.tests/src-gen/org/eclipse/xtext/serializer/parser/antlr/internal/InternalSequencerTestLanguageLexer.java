...
public class InternalSequencerTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ID1() throws RecognitionException {
        try {
            int _type = RULE_ID1;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4456:10: ( '$1' RULE_ID )
            // InternalSequencerTestLanguage.g:4456:12: '$1' RULE_ID
            {
            match("$1"); 
    ...
    public final void mRULE_ID2() throws RecognitionException {
        try {
            int _type = RULE_ID2;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4458:10: ( '$2' RULE_ID )
            // InternalSequencerTestLanguage.g:4458:12: '$2' RULE_ID
            {
            match("$2"); 
    ...
    public final void mRULE_ID3() throws RecognitionException {
        try {
            int _type = RULE_ID3;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4460:10: ( '$3' RULE_ID )
            // InternalSequencerTestLanguage.g:4460:12: '$3' RULE_ID
            {
            match("$3"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4462:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalSequencerTestLanguage.g:4462:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalSequencerTestLanguage.g:4462:11: ( '^' )?
            int alt1=2;
            ...
            // InternalSequencerTestLanguage.g:4462:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4464:10: ( ( '0' .. '9' )+ )
            // InternalSequencerTestLanguage.g:4464:12: ( '0' .. '9' )+
            {
            // InternalSequencerTestLanguage.g:4464:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalSequencerTestLanguage.g:4464:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4466:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalSequencerTestLanguage.g:4466:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalSequencerTestLanguage.g:4466:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalSequencerTestLanguage.g:4466:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalSequencerTestLanguage.g:4466:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalSequencerTestLanguage.g:4466:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalSequencerTestLanguage.g:4466:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalSequencerTestLanguage.g:4466:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalSequencerTestLanguage.g:4466:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalSequencerTestLanguage.g:4466:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalSequencerTestLanguage.g:4466:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4468:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalSequencerTestLanguage.g:4468:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalSequencerTestLanguage.g:4468:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalSequencerTestLanguage.g:4468:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4470:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSequencerTestLanguage.g:4470:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalSequencerTestLanguage.g:4470:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalSequencerTestLanguage.g:4470:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalSequencerTestLanguage.g:4470:41: ( '\\r' )? '\\n'
                    {
                    // InternalSequencerTestLanguage.g:4470:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4472:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSequencerTestLanguage.g:4472:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSequencerTestLanguage.g:4472:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSequencerTestLanguage.g:4474:16: ( . )
            // InternalSequencerTestLanguage.g:4474:18: .
            {
            matchAny(); 
