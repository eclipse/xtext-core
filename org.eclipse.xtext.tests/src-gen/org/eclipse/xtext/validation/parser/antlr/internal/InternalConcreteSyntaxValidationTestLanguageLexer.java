...
public class InternalConcreteSyntaxValidationTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3479:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalConcreteSyntaxValidationTestLanguage.g:3479:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalConcreteSyntaxValidationTestLanguage.g:3479:11: ( '^' )?
            int alt1=2;
            ...
            // InternalConcreteSyntaxValidationTestLanguage.g:3479:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3481:10: ( ( '0' .. '9' )+ )
            // InternalConcreteSyntaxValidationTestLanguage.g:3481:12: ( '0' .. '9' )+
            {
            // InternalConcreteSyntaxValidationTestLanguage.g:3481:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalConcreteSyntaxValidationTestLanguage.g:3481:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3483:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalConcreteSyntaxValidationTestLanguage.g:3483:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalConcreteSyntaxValidationTestLanguage.g:3483:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalConcreteSyntaxValidationTestLanguage.g:3483:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalConcreteSyntaxValidationTestLanguage.g:3483:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalConcreteSyntaxValidationTestLanguage.g:3483:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalConcreteSyntaxValidationTestLanguage.g:3483:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalConcreteSyntaxValidationTestLanguage.g:3483:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalConcreteSyntaxValidationTestLanguage.g:3483:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalConcreteSyntaxValidationTestLanguage.g:3483:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalConcreteSyntaxValidationTestLanguage.g:3483:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3485:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalConcreteSyntaxValidationTestLanguage.g:3485:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalConcreteSyntaxValidationTestLanguage.g:3485:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalConcreteSyntaxValidationTestLanguage.g:3485:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3487:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalConcreteSyntaxValidationTestLanguage.g:3487:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalConcreteSyntaxValidationTestLanguage.g:3487:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalConcreteSyntaxValidationTestLanguage.g:3487:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalConcreteSyntaxValidationTestLanguage.g:3487:41: ( '\\r' )? '\\n'
                    {
                    // InternalConcreteSyntaxValidationTestLanguage.g:3487:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3489:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalConcreteSyntaxValidationTestLanguage.g:3489:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalConcreteSyntaxValidationTestLanguage.g:3489:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalConcreteSyntaxValidationTestLanguage.g:3491:16: ( . )
            // InternalConcreteSyntaxValidationTestLanguage.g:3491:18: .
            {
            matchAny(); 
