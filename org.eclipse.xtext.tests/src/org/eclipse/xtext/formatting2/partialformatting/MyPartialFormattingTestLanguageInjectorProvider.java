 ...
 */
public class MyPartialFormattingTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected BeeLangTestLanguageRuntimeModule createRuntimeModule() {
		// make it work also with Maven/Tycho and OSGI
		// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=493672
		return new BeeLangTestLanguageRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return MyPartialFormattingTestLanguageInjectorProvider.class
						.getClassLoader();
			}
		};
	}
